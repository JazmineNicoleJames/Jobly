...
class Company {
  ...
  /*** Find companies based on query string filter,
      * Can filter by name, minEmployees, maxEmployees, or all 3
      * * Returns [{ filtered: [handle, name, description, num_employees, logoUrl] }, ...]
      * */
  ...
  if(minEmployees){
    query += ` AND numEmployees >= $${values.length +1}`;
